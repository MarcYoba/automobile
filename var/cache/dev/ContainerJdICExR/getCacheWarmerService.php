...
class getCacheWarmerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        return $container->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(new RewindableGenerator(function () use ($container) {
            ...
            yield 5 => ($container->privates['webpack_encore.entrypoint_lookup.cache_warmer'] ?? ($container->privates['webpack_encore.entrypoint_lookup.cache_warmer'] = new \Symfony\WebpackEncoreBundle\CacheWarmer\EntrypointCacheWarmer(['_default' => 'D:\\automobile/public/build/entrypoints.json'], ($container->targetDir.''.'/webpack_encore.cache.php'))));
