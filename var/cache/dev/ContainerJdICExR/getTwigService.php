...
class getTwigService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->addPath('D:\\automobile\\vendor\\symfony\\security-bundle/Resources/views', 'Security');
        $a->addPath('D:\\automobile\\vendor\\symfony\\security-bundle/Resources/views', '!Security');
        $a->addPath('D:\\automobile\\vendor\\doctrine\\doctrine-bundle/templates', 'Doctrine');
        $a->addPath('D:\\automobile\\vendor\\doctrine\\doctrine-bundle/templates', '!Doctrine');
        $a->addPath('D:\\automobile\\vendor\\doctrine\\doctrine-migrations-bundle/templates', 'DoctrineMigrations');
        $a->addPath('D:\\automobile\\vendor\\doctrine\\doctrine-migrations-bundle/templates', '!DoctrineMigrations');
        $a->addPath('D:\\automobile/templates');
        $a->addPath('D:\\automobile\\vendor\\symfony\\twig-bridge/Resources/views/Email', 'email');
        $a->addPath('D:\\automobile\\vendor\\symfony\\twig-bridge/Resources/views/Email', '!email');
        $a->addPath('D:\\automobile\\vendor\\symfony\\twig-bridge/Resources/views/Form');
